...
| `crypto/blake2b-256`, `crypto/chacha20poly1305-ietf/{seal,open}`, `crypto/random` | ungated host transforms | the §4.2 content hash, §4.4 authenticated encryption, and the entropy for content keys (nonces are derived, not drawn, §4.4) |
